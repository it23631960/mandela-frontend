...
const Products = () => {
  const categories = ["Women's", "Men's", "Footwear", "Accessories", "Kids"];
  ...
  useEffect(() => {
    axios
      .get(import.meta.env.VITE_API_BASE_URL + "/suppliers")
  ...
  const addProduct = () => {
    axios
      .post(import.meta.env.VITE_API_BASE_URL + "/products", newProduct)
  ...
  const deleteProduct = (id) => {
    axios
      .delete(`${import.meta.env.VITE_API_BASE_URL}/products/${id}`)
  ...
  const displayedProducts = filteredProducts.filter((product) => {
    ...
    if (filter === "Limited")
      return matchesSearch && product.quantity > 0 && product.quantity < 5;
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <div className="space-y-2">
              ...
              <div className="w-full">
                <label
                  htmlFor="imageUpload"
                  className="flex items-center justify-center w-full px-4 py-3 bg-white border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer hover:bg-gray-50 transition duration-200"
                >
                  <svg
