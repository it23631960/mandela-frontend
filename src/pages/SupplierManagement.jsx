...
const SupplierManagement = () => {
  ...
  const handleInputChange = (e, formType = "new") => {
    ...
    const updateSupplier =
      formType === "new" ? setNewSupplier : setEditSupplier;
    if (name.includes(".")) {
  ...
  const updateSupplier = async () => {
    try {
      const res = await axios.put(
        `${API_URL}/${editSupplier.id}`,
        editSupplier
      );
      setSuppliers(
        suppliers.map((s) => (s.id === editSupplier.id ? res.data : s))
      );
            ...
            <div className="space-y-4">
              ...
              <div className="border-b pb-4">
                ...
                <p className="text-lg font-medium">
                  {selectedSupplier.contactPerson.firstName}{" "}
                  {selectedSupplier.contactPerson.lastName}
                </p>
                <p className="text-lg font-medium">
